...
async function initialCompilation(cliOptions, swcOptions) {
    const { includeDotfiles , filenames , copyFiles , extensions , outDir , stripLeadingPaths , sync , quiet , watch , only , ignore  } = cliOptions;
...
async function watchCompilation(cliOptions, swcOptions) {
    const { includeDotfiles , filenames , copyFiles , extensions , outDir , stripLeadingPaths , quiet , sync  } = cliOptions;
